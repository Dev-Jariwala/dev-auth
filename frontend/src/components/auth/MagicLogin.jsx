...
import { generateMagicLink } from "../../services/authServices"
        ...
        <>
            ...
            <div className="flex justify-center items-center min-h-[calc(100vh-4rem)]">
                <Card className=" p-6 rounded-md shadow-md w-full max-w-md">
                    <h1 className="text-2xl font-bold mb-4 text-center">Magic Login</h1>
                    <Form {...form}>
                        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
                            ...
                            {isMagicLinkSent && (
                                <Alert className="bg-blue-50 border-blue-200 text-blue-800">
                                    ...
                                    <AlertTitle className="text-blue-800 font-semibold">Magic Link Sent</AlertTitle>
                                    <AlertDescription className="text-blue-700">
                                        A magic link has been sent to your email address. Please check your inbox and click the link to log
                                        in.
                                    </AlertDescription>
                                </Alert>
                            )}
